...
public class Zadatak2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        a.moveToElement(driver.findElement(By.id("menu-item-6408"))).perform();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='menu-item-6408']/ul")));
        Thread.sleep(1000);

        a.moveToElement(driver.findElement(By.id("menu-item-5362"))).perform();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By
                .xpath("//*[@id='menu-item-5362']/ul")));
        Thread.sleep(1000);

        a.moveToElement(driver.findElement(By.id("menu-item-5453"))).perform();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By
